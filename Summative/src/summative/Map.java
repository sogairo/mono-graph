...
public class Map {
    ...
    private final Minigame[][] minigames = new Minigame[MAP_SIZE][MAP_SIZE];
    public String[][] worldMap = new String[MAP_SIZE][MAP_SIZE];
    private final PImage[][] sectionBackground = new PImage[MAP_SIZE][MAP_SIZE];

    public int playerX = 0, playerY = 1;
    private PApplet app;
    private Player user;
    ...
    private void generation() {
        ...
        minigames[0][0] = new WheatMinigame(app, user, 180, 140, 285);
        sectionBackground[0][0] = app.loadImage("images/backgrounds/wheatfield.png");
        
        minigames[0][1] = new FriedRiceMinigame(app, user, 280, 420, 90);
